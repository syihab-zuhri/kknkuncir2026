...
Phase 0 dan Phase 1 telah tersedia di production. Implementasi Phase 2 untuk konfigurasi kelompok, roster mahasiswa, provisioning/edit/deactivation, impor CSV, dan profil ownership-scoped sudah selesai pada branch `feat/phase-2-group-students` serta menunggu rollout terkontrol. Worker production masih menjalankan merge commit Phase 1 `bdfa8a0` sampai pull request Phase 2 digabung dan Workers Builds lulus. QR attendance, sesi, scheduler, dashboard, serta Phase 3 dan seterusnya belum dimulai.
