/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: caf63f7fddd1b6c06ac1f09e68121447)
...
interface __BaseEnv_CloudflareEnv {
	...
	ASSETS: Fetcher;
	APP_NAME: "kkndesakuncir-preview" | "kkndesakuncir";
	APP_URL: "http://127.0.0.1:8787" | "https://zuhrirey.my.id";
	APP_TIMEZONE: "Asia/Jakarta";
	BOOTSTRAP_ADMIN_USERNAME: "admin";
	BOOTSTRAP_ADMIN_NAME: "Preview Administrator" | "Administrator";
}
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		...
		ADMIN_MUTATION_RATE_LIMITER: RateLimit;
		ASSETS: Fetcher;
		APP_NAME: "kkndesakuncir-preview";
		APP_URL: "http://127.0.0.1:8787";
		APP_TIMEZONE: "Asia/Jakarta";
		BOOTSTRAP_ADMIN_USERNAME: "admin";
		BOOTSTRAP_ADMIN_NAME: "Preview Administrator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "APP_URL" | "APP_TIMEZONE" | "BOOTSTRAP_ADMIN_USERNAME" | "BOOTSTRAP_ADMIN_NAME">> {}
}
